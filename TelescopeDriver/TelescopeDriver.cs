...
//
// ASCOM Telescope driver for DDScopeX
//
// Description:	 ASCOM Driver for the DDScope (Direct Drive Telescope)
//
// Implements:	ASCOM Telescope interface version: 1.0
// Author:		Richard Benear 7/13/25
//
...
namespace ASCOM.DDScopeX.Telescope
{
    ...
    //
    // Your driver's DeviceID is ASCOM.DDScopeX.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.DDScopeX.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _DDScopeX from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("a9850559-f316-4f9a-88f6-615350058bce")]
    [ProgId("ASCOM.DDScopeX.Telescope")]
    [ServedClassName("Telescope Driver for DDScopeX")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DDScopeX"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "DDScopeX.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.DDScopeX.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
